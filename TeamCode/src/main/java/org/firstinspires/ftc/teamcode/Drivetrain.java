...
public class Drivetrain {
    ...
    public class alignBackward implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket packet) {
            ...
            BL.setPower(0.5);
            BR.setPower(0.5);
            FL.setTargetPosition(FL.getCurrentPosition()-310);
            FR.setTargetPosition(FR.getCurrentPosition()-310);
            BL.setTargetPosition(BL.getCurrentPosition()-310);
            BR.setTargetPosition(BR.getCurrentPosition()-310);
            FL.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            FR.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            BL.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            BR.setMode(DcMotor.RunMode.RUN_TO_POSITION);
